                  ...
                  <tr v-for="product in store.productsOnCart">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                      <div class="flex items-center justify-between w-24">
                        <button class="text-gray-500 hover:text-gray-700" @click="decrease(product.id)" aria-label="Decrease quantity">
                          <svg class="w-4 h-4 fill-current" viewBox="0 0 20 20">
                            <path d="M5 10h10v1H5z"></path>
                          </svg>
                        </button>
                        <span class="text-gray-700">{{ product.quantity }}</span>
                        <button class="text-gray-500 hover:text-gray-700" @click="increase(product.id)" aria-label="Increase quantity">
                          <svg class="w-4 h-4 fill-current" viewBox="0 0 20 20">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                      <button class="text-gray-500 hover:text-gray-700" @click="removeItem(product.id)" aria-label="Remove item">
                        <svg class="w-4 h-4 fill-current" viewBox="0 0 20 20">
